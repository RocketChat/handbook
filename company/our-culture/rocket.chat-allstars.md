...
1. Both **Share content selected to be promoted **and **Create an original post for LinkedIn **are monthly categories, meaning you can get that point once a month. These posts will always be related to the monthly webinar campaigns and you can get these stars either just sharing _the selected content on LinkedIn _or by _writing your own post _directed to that campaign!
...
### Leader's Monthly Attributed Stars

Leaders also get 50 stars per month that they can attribute to any Rocketeer in their team that they want to recognize!! To attribute these stars, you (leader) just need to:

1. Go to the [stars request page](https://open.rocket.chat/direct/%7Busername%7D) on Zoho People
2. Choose the person you want to recognize in the "Employee ID" field
3. Choose "Credit" and the type "Leader's monthly attributed stars"
4. In the "Points" field, select how many of the 50 stars you want to give that person. This is an important point, since it is up to you if you want to attribute all 50 points to one person at once or manage this amount during the month.
5. Submit!
